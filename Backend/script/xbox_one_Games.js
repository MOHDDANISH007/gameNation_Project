...
import XboxOneGames from "../models/xbox_one/xbox_one.model.js";
import XboxOneDetails from "../models/xbox_one/xbox.one_detail.model.js";
...
const xboxOneData = [
    {
        "Type": "XBOX_ONE",
        "game_id": 1,
        "game_name": "Cyberpunk 2077: Phantom Liberty (Xbox One Edition)",
        "price_inr": 4599,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 2,
        "game_name": "Mafia 3 (Xbox One Edition)",
        "price_inr": 5399,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 3,
        "game_name": "GTA 5 (Xbox One Edition)",
        "price_inr": 4999,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 4,
        "game_name": "Alan Wake 2 (Xbox One Edition)",
        "price_inr": 4199,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 5,
        "game_name": "State of Decay 3 (Xbox One Edition)",
        "price_inr": 4299,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 6,
        "game_name": "Hellblade II: Senua’s Saga (Xbox One Edition)",
        "price_inr": 4799,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 7,
        "game_name": "Fable Reimagined (Xbox One Edition)",
        "price_inr": 4999,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 8,
        "game_name": "The Witcher 3 (Xbox One Edition)",
        "price_inr": 5599,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 9,
        "game_name": "Control  (Xbox One Edition)",
        "price_inr": 3899,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 10,
        "game_name": "Star Wars: Eclipse (Xbox One Edition)",
        "price_inr": 5199,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 11,
        "game_name": "Far Cry 6 (Xbox One Edition)",
        "price_inr": 1599,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 12,
        "game_name": "Hogwarts Legacy (Xbox One Edition)",
        "price_inr": 4299,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 13,
        "game_name": "Assassin's Creed Syndicate (Xbox One Edition)",
        "price_inr": 5399,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 14,
        "game_name": "FIFA 23 (Xbox One Edition)",
        "price_inr": 2099,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 15,
        "game_name": "Sonic X Shadow Generations (Xbox One Edition)",
        "price_inr": 3099,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 16,
        "game_name": "Hitman 3 (Xbox One Edition)",
        "price_inr": 5599,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 17,
        "game_name": "Red Dead Redemption 2 (Xbox One Edition)",
        "price_inr": 4699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 18,
        "game_name": "Fatal Fury: City of the Wolves (Xbox One Edition)",
        "price_inr": 3099,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 19,
        "game_name": "Days Gone  (Xbox One Edition)",
        "price_inr": 4099,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 20,
        "game_name": "Doom: The Dark Ages (Xbox One Edition)",
        "price_inr": 4699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 21,
        "game_name": "Ghost Recon Wildlands (Xbox One Edition)",
        "price_inr": 5699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 22,
        "game_name": "Ghost Recon Breakpoint (Xbox One Edition)",
        "price_inr": 5699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 23,
        "game_name": "Battlefield 2042 (Xbox One Edition)",
        "price_inr": 2799,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 24,
        "game_name": "Battlefield V (Xbox One Edition)",
        "price_inr": 3199,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 25,
        "game_name": "Crickets (Xbox One Edition)",
        "price_inr": 4699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 26,
        "game_name": "Forza Horizon 5 (Xbox One Edition)",
        "price_inr": 3699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 27,
        "game_name": "Call of Duty: Black Ops 6 (Xbox One Edition)",
        "price_inr": 4999,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 28,
        "game_name": "Watch Dog 2 (Xbox One Edition)",
        "price_inr": 5699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 29,
        "game_name": "The Outer Worlds 2 (Xbox One Edition)",
        "price_inr": 4699,
    ...
    },
    {
        "Type": "XBOX_ONE",
        "game_id": 30,
        "game_name": "Star Wars Jedi: Fallen Order (Xbox One Edition)",
        "price_inr": 5999,
...
async function insertXboxOneGames() {
    try {
        // clear data from the database
        await XboxOneGames.deleteMany({});
        await XboxOneDetails.deleteMany({});

        // insert Xbox One games data
        const result = await XboxOneGames.insertMany(xboxOneData);
        const resultDetails = await XboxOneDetails.insertMany(xboxOneDetailsData);

        console.log(`Inserted ${result.length} Xbox One games`);
        console.log(`Inserted ${resultDetails.length} Xbox One game details`);

    }
    catch (error) {
        console.error("Error inserting Xbox One games:", error);
    }
}
